...
## Project Structure
    ...
    ├── testapiautocatalog_127087  # Django project configurations
...
1. Clone this repo and `cd testapiautocatalog_127087`
...
2. Clone this repo and `cd testapiautocatalog_127087`
